...
%prep
%setup -q -n gst-plugins-bad-1.8.2
...
/usr/include/gstreamer-1.0/gst/gl/egl/gsteglimagememory.h
...
/usr/share/gtk-doc/html/gst-plugins-bad-plugins-1.0/gst-plugins-bad-plugins-pyramidsegment.html
